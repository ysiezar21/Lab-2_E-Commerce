    ...
    compiler.hooks.compilation.tap(pluginName, compilation => {
      ...
      if (this.options.generator) {
        const generatorData = getSerializeJavascript()({
          generator: Array.isArray(this.options.generator.implementation) ? this.options.generator.implementation.map(getVersion) : getVersion(/** @type {BasicMinimizerImplementation<EXPECTED_ANY> & MinimizeFunctionHelpers} */
